  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Container(
          // tRC (1:227)
          padding: EdgeInsets.fromLTRB(17 * fem, 38 * fem, 18 * fem, 171 * fem),
          width: double.infinity,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 147 * fem, 13 * fem),
                width: 202 * fem,
                height: 2 * fem,
                decoration: BoxDecoration(
              ...
              Container(
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 26 * fem, 42 * fem),
                constraints: BoxConstraints(
                  maxWidth: 319 * fem,
                ),
                child: Text(
              ...
              Container(
                margin:
                    EdgeInsets.fromLTRB(0 * fem, 0 * fem, 122 * fem, 19 * fem),
                child: Text(
              ...
              Container(
                margin:
                    EdgeInsets.fromLTRB(11 * fem, 0 * fem, 11 * fem, 1 * fem),
                width: double.infinity,
                height: 184 * fem,
                child: Stack(
                  children: [
