  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Container(
          padding: EdgeInsets.fromLTRB(14 * fem, 40 * fem, 0 * fem, 179 * fem),
          width: double.infinity,
            ...
            children: [
              Container(
                margin: EdgeInsets.fromLTRB(
                    40 * fem, 0 * fem, 54.1 * fem, 53.21 * fem),
                width: double.infinity,
                height: 182.79 * fem,
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(
                          3.83 * fem, 7.67 * fem, 0 * fem, 18.46 * fem),
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(
                          3.83 * fem, 7.66 * fem, 0 * fem, 18.67 * fem),
                      height: double.infinity,
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(20 * fem),
                        gradient: const LinearGradient(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 0 * fem, 0 * fem, 22.76 * fem),
                            width: 143.07 * fem,
                            height: 108.58 * fem,
                            child: Image.asset(
                              'assets/images/silky-journalism-1-yve.png',
                              fit: BoxFit.cover,
                            ),
                          ),
                          Container(
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 0 * fem, 4.73 * fem, 0 * fem),
                            child: Text(
                              'Practice',
                              textAlign: TextAlign.center,
                              style: SafeGoogleFont(
